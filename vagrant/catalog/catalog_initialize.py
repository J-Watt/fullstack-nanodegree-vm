...
session.add_all([
    Item(name = "Disc", description = "Official 175g game disc!"
         ...
         "vehicula, id facilisis ipsum bibendum. Nam suscipit, libero tincidunt"
         " feugiat fermentum, eros ex luctus elit, eu porta nisl mauris ac "
         "nibh. Donec risus enim, tempor eget maximus quis, lobortis eu nulla. "
         ...
         "Donec vel enim tincidunt, iaculis purus eget, commodo mi. Vestibulum "
    ...
    Item(name = "Gloves", description = "Friction ultimate gloves!"
         ...
         "consectetur lacinia est. Nullam eget diam quis dolor tincidunt luctus"
